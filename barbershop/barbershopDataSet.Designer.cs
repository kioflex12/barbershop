...
namespace barbershop {
    ...
    public partial class barbershopDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientsDataTable : global::System.Data.TypedTableBase<ClientsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ClientsRow AddClientsRow(int Id_client, System.DateTime date_of_birth, string full_name, string service, int price) {
...
namespace barbershop.barbershopDataSetTableAdapters {
    ...
    public partial class ClientsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Clients] WHERE (([Id_client] = @Original_Id_client) AND ([date" +
                "_of_birth] = @Original_date_of_birth) AND ([full_name] = @Original_full_name) AN" +
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Clients] ([Id_client], [date_of_birth], [full_name], [service], [price]) VALUES (@Id_client, @date_of_birth, @full_name, @service, @price);
SELECT Id_client, date_of_birth, full_name, service, price FROM Clients WHERE (Id_client = @Id_client)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@service", global::System.Data.SqlDbType.Text, 0, global::System.Data.ParameterDirection.Input, 0, 0, "service", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clients] SET [Id_client] = @Id_client, [date_of_birth] = @date_of_birth, [full_name] = @full_name, [service] = @service, [price] = @price WHERE (([Id_client] = @Original_Id_client) AND ([date_of_birth] = @Original_date_of_birth) AND ([full_name] = @Original_full_name) AND ([price] = @Original_price));
SELECT Id_client, date_of_birth, full_name, service, price FROM Clients WHERE (Id_client = @Id_client)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@service", global::System.Data.SqlDbType.Text, 0, global::System.Data.ParameterDirection.Input, 0, 0, "service", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id_client, date_of_birth, full_name, service, price FROM dbo.Clients";
        ...
        public virtual int Fill(barbershopDataSet.ClientsDataTable dataTable) {
        ...
        public virtual barbershopDataSet.ClientsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            barbershopDataSet.ClientsDataTable dataTable = new barbershopDataSet.ClientsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(barbershopDataSet.ClientsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id_client, System.DateTime Original_date_of_birth, string Original_full_name, int Original_price) {
        ...
        public virtual int Insert(int Id_client, System.DateTime date_of_birth, string full_name, string service, int price) {
        ...
        public virtual int Update(int Id_client, System.DateTime date_of_birth, string full_name, string service, int price, int Original_Id_client, System.DateTime Original_date_of_birth, string Original_full_name, int Original_price) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((System.DateTime)(Original_date_of_birth));
            if ((Original_full_name == null)) {
                throw new global::System.ArgumentNullException("Original_full_name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime date_of_birth, string full_name, string service, int price, int Original_Id_client, System.DateTime Original_date_of_birth, string Original_full_name, int Original_price) {
            return this.Update(Original_Id_client, date_of_birth, full_name, service, price, Original_Id_client, Original_date_of_birth, Original_full_name, Original_price);
        }
    }
